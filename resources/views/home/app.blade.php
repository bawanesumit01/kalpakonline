...
<html lang="en">
  <head>
    <title>Kalpak Online Store</title>
    <meta charset="utf-8">
    ...
    {{-- ✅ Preload jQuery since everything depends on it --}}
    <link rel="preload" href="{{ asset('/assets/home/js/jquery-1.11.0.min.js') }}" as="script">
    ...
    <link rel="preload" href="{{ asset('/assets/home/css/vendor.css') }}" as="style">
    <link rel="preload" href="{{ asset('/assets/home/css/style.css') }}" as="style">
    <link rel="preload" href="{{ asset('/assets/home/js/jquery-1.11.0.min.js') }}" as="script">
    <link rel="stylesheet" type="text/css" href="{{ asset('/assets/home/css/vendor.css') }}?v={{ filemtime(public_path('assets/home/css/vendor.css')) }}">
    <link rel="stylesheet" type="text/css" href="{{ asset('/assets/home/css/style.css') }}?v={{ filemtime(public_path('assets/home/css/style.css')) }}">
  ...
  <body>
    ...
    <div class="offcanvas-header border-bottom">
        <h5 class="offcanvas-title">
            ...
            Your Cart
            <span class="badge bg-primary rounded-pill ms-2 cart-count">{{ $cartCount ?? 0 }}</span>
        </h5>
    ...
    <div class="offcanvas-body d-flex flex-column p-0">
        ...
        {{-- Cart Items --}}
        <div class="cart-items-wrapper flex-grow-1 overflow-auto p-3" id="offcanvas-cart-items">
                ...
                <div class="cart-item d-flex align-items-center gap-3 border-bottom py-3" id="offcanvas-item-{{ $item->id }}">
                    ...
                    <div class="flex-grow-1">
                        ...
                        <div class="d-flex align-items-center gap-2 mt-2">
                            <button class="btn btn-outline-secondary btn-sm px-2 py-0 offcanvas-qty-decrease"
                                    data-cart-id="{{ $item->id }}">−</button>
                            <span class="offcanvas-qty fw-semibold" data-cart-id="{{ $item->id }}">{{ $item->quantity }}</span>
                            <button class="btn btn-outline-secondary btn-sm px-2 py-0 offcanvas-qty-increase"
                                    data-cart-id="{{ $item->id }}">+</button>
                        </div>
                    </div>
                    ...
                    <div class="text-end">
                        ...
                        <button class="btn btn-link text-danger p-0 mt-1 offcanvas-remove"
            ...
            @else
                <div class="text-center py-5" id="empty-cart-msg">
                    <svg width="48" height="48" class="text-muted"><use xlink:href="#cart"></use></svg>
        ...
        <div class="cart-footer border-top p-3" id="offcanvas-cart-footer"
             style="{{ isset($cartItems) && $cartItems->count() > 0 ? '' : 'display:none' }}">
      ...
      <div class="offcanvas-body">
        ...
        <ul class="navbar-nav justify-content-end menu-list list-unstyled d-flex gap-md-3 mb-0">
          ...
          <li class="nav-item border-dashed active">
            <a href="{{ route('home.index') }}" class="nav-link d-flex align-items-center gap-3 text-dark p-2">
          ...
          <li class="nav-item border-dashed">
            <button class="btn btn-toggle dropdown-toggle position-relative w-100 d-flex justify-content-between align-items-center text-dark p-2"
              ...
              <ul class="btn-toggle-nav list-unstyled fw-normal ps-5 pb-1">
                @foreach ($categories as $category)
                  <li class="border-bottom py-2">
                    <a href="#" class="dropdown-item">{{ $category->category_name }}</a>
                  </li>
                @endforeach
              </ul>
            </div>
    ...
    {{-- ✅ CDN scripts - defer so they don't block page render --}}
    <script defer
    ...
    <script src="{{ asset('/assets/home/js/jquery-1.11.0.min.js') }}?v={{ filemtime(public_path('assets/home/js/jquery-1.11.0.min.js')) }}"></script>
    <script defer src="{{ asset('/assets/home/js/plugins.js') }}?v={{ filemtime(public_path('assets/home/js/plugins.js')) }}"></script>
