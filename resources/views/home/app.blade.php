...
<head>
    ...
    <link rel="stylesheet" type="text/css"
        href="{{ asset('/assets/home/css/vendor.css') }}?v={{ filemtime(public_path('assets/home/css/vendor.css')) }}">
    <link rel="stylesheet" type="text/css"
        href="{{ asset('/assets/home/css/style.css') }}?v={{ filemtime(public_path('assets/home/css/style.css')) }}">
...
<body>
                ...
                @if (isset($cartItems) && $cartItems->count() > 0)
                    @foreach ($cartItems as $item)
                        <div class="cart-item d-flex align-items-center gap-3 border-bottom py-3"
                            id="offcanvas-item-{{ $item->id }}">

                            {{-- Product Image --}}
                            <img src="{{ asset('/' . $item->product->main_image) }}" width="60" height="60"
                                class="rounded object-fit-cover" alt="{{ $item->product->product_name }}">
                            ...
                            <div class="flex-grow-1">
                                ...
                                <div class="d-flex align-items-center gap-2 mt-2">
                                    ...
                                    <span class="offcanvas-qty fw-semibold"
                                        data-cart-id="{{ $item->id }}">{{ $item->quantity }}</span>
    ...
    <script
        src="{{ asset('/assets/home/js/jquery-1.11.0.min.js') }}?v={{ filemtime(public_path('assets/home/js/jquery-1.11.0.min.js')) }}">
    </script>
    <script defer
        src="{{ asset('/assets/home/js/plugins.js') }}?v={{ filemtime(public_path('assets/home/js/plugins.js')) }}">
    </script>
    <script defer
