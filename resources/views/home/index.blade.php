                        ...
                        <div class="swiper-wrapper">
                            @foreach ($categories as $category)
                                <a href="#" class="nav-link swiper-slide text-center">
                                    ...
                                    <h4 class="fs-6 mt-3 fw-normal category-title">{{ $category->category_name ?? null }}
                                    </h4>
                                </a>
                            @endforeach
                        </div>
            ...
            <div class="row">
                <div class="col-md-12">
                    ...
                    <div class="section-header d-flex flex-wrap justify-content-between my-4">
                        ...
                        <div class="d-flex align-items-center">
                            <a href="{{ route('shop') }}" class="btn btn-primary rounded-1">View All</a>
                        </div>
                    </div>
                        ...
                        @foreach ($products as $product)
                            <div class="col">
                                <div class="product-item">
                                    <figure>
                                        <a href="{{ route('product.details', $product->id) }}" title="Product Title">
                                            <img src="{{ asset('/' . $product->main_image) }}"
                                                alt="{{ $product->product_name ?? null }}" class="tab-image">
                                        </a>
                                    </figure>
                                    <div class="d-flex flex-column text-center">
                                        <h3 class="fs-6 fw-normal">{{ $product->product_name ?? null }}</h3>
                                        <div class="d-flex justify-content-center align-items-center gap-2">
                                            <!--<del>$24.00</del>-->
                                            <span class="text-dark fw-semibold">&#8377;
                                                {{ $product->final_price ?? null }}</span>
                                        </div>
