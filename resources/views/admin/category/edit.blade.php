                ...
                <div class="mdc-layout-grid__cell stretch-card mdc-layout-grid__cell--span-12">
                    <div class="mdc-card p-0">
                        ...
                        <form class="shadow pt-3" method="POST"
                            action="{{ route('category.update', $category->category_id) }}" enctype="multipart/form-data">
                            @csrf
                            @method('PUT')
                            <div class="row m-2">
                                            ...
                                            <select class="mdc-text-field__input" id="ven" name="vendor_id" required>
                                                ...
                                                @foreach ($vendors as $vendor)
                                                    <option value="{{ $vendor->vendor_id }}"
                                                        {{ old('vendor_id', $category->vendor_id) == $vendor->vendor_id ? 'selected' : '' }}>
                                                        {{ $vendor->vendor_name }}
                                                    </option>
                                                @endforeach
                                ...
                                <div class="col-md-4 my-2">
                                    ...
                                    <!-- Image Preview -->
                                    <div class="mt-2">
                                        <img id="catImagePreview" src="{{ asset('/categoryImage/' . $category->cat_image) }}"
