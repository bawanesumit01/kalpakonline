            ...
            <div class="mdc-layout-grid">
                <div class="mdc-layout-grid__cell stretch-card mdc-layout-grid__cell--span-12">
                    <div class="mdc-card p-0">
                        ...
                        <!-- form -->
                        <form class="shadow pt-3" method="POST" action="{{ route('vendor.update', $vendor->vendor_id) }}">
                            @csrf
                            @method('PUT')
                            <div class="row m-2">
                                ...
                                <div class="col-md-6 my-2">
                                    <div class="mdc-text-field mdc-text-field--outlined">
                                        <input class="mdc-text-field__input" id="name" type="text" name="name"
                                            value="{{ old('name', $vendor->user->name) }}" required autocomplete="name">
                                        <div class="mdc-notched-outline">
                                            <div class="mdc-notched-outline__leading"></div>
                                            <div class="mdc-notched-outline__notch">
                                ...
                                <div class="col-md-6 my-2">
                                    <div class="mdc-text-field mdc-text-field--outlined">
                                        <input class="mdc-text-field__input" id="email" type="email" name="email"
                                            value="{{ old('email', $vendor->user->email) }}" required autocomplete="email">
                                        <div class="mdc-notched-outline">
                                            <div class="mdc-notched-outline__leading"></div>
                                            <div class="mdc-notched-outline__notch">
                                ...
                                <div class="col-md-6 my-2">
                                    <div class="mdc-text-field mdc-text-field--outlined">
                                        ...
                                        id="mobile" type="number" name="mobile" value="{{ old('mobile', $vendor->user->mobile) }}" required autofocus autocomplete="name">
                                        <div class="mdc-notched-outline">
                                            <div class="mdc-notched-outline__leading"></div>
                                            <div class="mdc-notched-outline__notch">
                                ...
                                <div class="col-md-6 my-2">
                                    <div class="mdc-text-field mdc-text-field--outlined">
                                        <select class="mdc-text-field__input" id="role" name="role" required>
                                            ...
                                            <option value="admin"
                                                {{ old('role', $vendor->user->role) == 'admin' ? 'selected' : '' }}>Admin
                                            </option>
                                            <option value="client"
                                                {{ old('role', $vendor->user->role) == 'client' ? 'selected' : '' }}>Client
                                            </option>
                                        </select>
                                        <div class="mdc-notched-outline">
                                            <div class="mdc-notched-outline__leading"></div>
                                ...
                                @if (auth()->user()->role === 'superadmin')
                                    ...
                                    <div class="col-md-12 my-3">
                                        ...
                                        <div class="row">
                                            @foreach (['dashboard','vendors', 'category', 'products'] as $perm)
                                                <div class="col-md-3 mdc-form-field">
                                                    <div class="mdc-checkbox">
                                                        <input type="checkbox" id="basic-disabled-checkbox2"
                                                            ...
                                                            value="{{ $perm }}"
                                                            {{ in_array($perm, $vendor->user->permissions ?? []) ? 'checked' : '' }} />
                                                    ...
                                                    <label for="basic-disabled-checkbox2"
                                                        id="basic-disabled-checkbox-label2">{{ ucfirst($perm) }}</label>
