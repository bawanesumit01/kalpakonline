            ...
            <div class="mdc-layout-grid">
                <div class="mdc-layout-grid__cell stretch-card mdc-layout-grid__cell--span-12">
                    <div class="mdc-card p-0">
                        ...
                        <!-- form -->
                        <form class="shadow pt-3" method="POST" action="{{ route('products.update', $product->id) }}"
                            ...
                            <div class="row m-2">
                                ...
                                <div class="col-md-4 my-2">
                                    <div class="mdc-text-field mdc-text-field--outlined">
                                        <input class="mdc-text-field__input" id="product_sku" type="text"
                                            name="product_sku" value="{{ old('product_sku', $product->product_sku) }}"
                                            ...
                                            <select class="mdc-text-field__input" id="vendor_id" name="vendor_id" required>
                                                ...
                                                @foreach ($vendors as $vendor)
                                                    <option value="{{ $vendor->vendor_id }}"
                                                        {{ $vendor->vendor_id == $product->vendor_id ? 'selected' : '' }}>
                                                        {{ $vendor->vendor_name }}
                                                    </option>
                                                @endforeach
                                            </select>
                                ...
                                <div class="col-md-4 my-2">
                                    <div class="mdc-text-field mdc-text-field--outlined">
                                        <input class="mdc-text-field__input" id="selling_price" type="number"
                                            name="selling_price"
                                            value="{{ old('selling_price', $product->selling_price) }}" required autofocus
                                    ...
                                    <div class="mdc-text-field mdc-text-field--outlined">
                                        <select class="mdc-text-field__input" id="stock_status" name="stock_status"
                                            ...
                                            <option value="pre_order"
                                                {{ $product->stock_status == 'pre_order' ? 'selected' : '' }}>Preorder
                                            </option>
                                        </select>
                                        <div class="mdc-notched-outline">
                                            <div class="mdc-notched-outline__leading"></div>
                                ...
                                <div class="col-md-4 my-2">
                                    ...
                                    <!-- Image Preview -->
                                    <div class="mt-2">
                                        <img id="mainImagePreview" src="{{ asset('/' . $product->main_image) }}"
                                ...
                                <div class="col-md-4 my-2">
                                    ...
                                    <div class="d-flex gap-2 mt-2 flex-wrap">
                                        @foreach ($product->images as $img)
                                            <img src="{{ asset('/' . $img->image_path) }}" width="80"
