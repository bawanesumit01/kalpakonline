            ...
            <div class="mdc-layout-grid">
                <div class="mdc-layout-grid__cell stretch-card mdc-layout-grid__cell--span-12">
                    <div class="mdc-card p-0">
                        ...
                        <!-- form -->
                        <form class="shadow pt-3" method="POST" action="<?php echo e(route('vendor.update', $vendor->vendor_id)); ?>">
                            <?php echo csrf_field(); ?>
                                ...
                                <div class="col-md-6 my-2">
                                    <div class="mdc-text-field mdc-text-field--outlined mdc-text-field--with-leading-icon">
                                        <input class="mdc-text-field__input" id="vendor_name" type="text"
                                            name="vendor_name" value="<?php echo e(old('vendor_name', $vendor->vendor_name)); ?>"
                                ...
                                <div class="col-md-6 my-2">
                                    <div class="mdc-text-field mdc-text-field--outlined">
                                        <input class="mdc-text-field__input" id="name" type="text" name="name"
                                            value="<?php echo e(old('name', $vendor->user->name)); ?>" required autocomplete="name">
                                        <div class="mdc-notched-outline">
                                            <div class="mdc-notched-outline__leading"></div>
                                            <div class="mdc-notched-outline__notch">
                                ...
                                <div class="col-md-6 my-2">
                                    <div class="mdc-text-field mdc-text-field--outlined">
                                        <input class="mdc-text-field__input" id="email" type="email" name="email"
                                            value="<?php echo e(old('email', $vendor->user->email)); ?>" required autocomplete="email">
                                        <div class="mdc-notched-outline">
                                            <div class="mdc-notched-outline__leading"></div>
                                            <div class="mdc-notched-outline__notch">
...
unset($__errorArgs, $__bag); ?>
                                ...
                                <div class="col-md-6 my-2">
                                    <div class="mdc-text-field mdc-text-field--outlined">
                                        ...
                                        id="mobile" type="number" name="mobile" value="<?php echo e(old('mobile', $vendor->user->mobile)); ?>" required autofocus autocomplete="name">
                                        <div class="mdc-notched-outline">
                                            <div class="mdc-notched-outline__leading"></div>
                                            <div class="mdc-notched-outline__notch">
                                ...
                                <div class="col-md-6 my-2">
                                    <div class="mdc-text-field mdc-text-field--outlined">
                                        ...
                                        <div class="mdc-notched-outline">
                                            <div class="mdc-notched-outline__leading"></div>
                                            <div class="mdc-notched-outline__notch">
                                                <label for="password" class="mdc-floating-label">Password (Leave blank to
                                                    keep)</label>
                                            </div>
                                            <div class="mdc-notched-outline__trailing"></div>
                                        </div>
                                ...
                                <div class="col-md-6 my-2">
                                    <div class="mdc-text-field mdc-text-field--outlined">
                                        <select class="mdc-text-field__input" id="role" name="role" required>
                                            ...
                                            <option value="admin"
                                                <?php echo e(old('role', $vendor->user->role) == 'admin' ? 'selected' : ''); ?>>Admin
                                            </option>
                                            <option value="client"
                                                <?php echo e(old('role', $vendor->user->role) == 'client' ? 'selected' : ''); ?>>Client
                                            </option>
                                        </select>
                                        <div class="mdc-notched-outline">
                                            <div class="mdc-notched-outline__leading"></div>
...
unset($__errorArgs, $__bag); ?>
                                ...
                                <?php if(auth()->user()->role === 'superadmin'): ?>
                                    ...
                                    <div class="col-md-12 my-3">
                                        ...
                                        <div class="row">
                                            <?php $__currentLoopData = ['dashboard','vendors', 'category', 'products']; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $perm): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                                <div class="col-md-3 mdc-form-field">
                                                    <div class="mdc-checkbox">
                                                        <input type="checkbox" id="basic-disabled-checkbox2"
                                                            ...
                                                            <?php echo e(in_array($perm, $vendor->user->permissions ?? []) ? 'checked' : ''); ?> />
                                                    ...
                                                    <label for="basic-disabled-checkbox2"
                                                        id="basic-disabled-checkbox-label2"><?php echo e(ucfirst($perm)); ?></label>
...
<?php echo $__env->make('layouts.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH /home/kalpakon/public_html/resources/views/admin/vendor/edit.blade.php ENDPATH**/ ?>