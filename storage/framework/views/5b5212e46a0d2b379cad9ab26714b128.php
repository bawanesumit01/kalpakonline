...
<head>
    ...
    <link rel="stylesheet" type="text/css"
        href="<?php echo e(asset('/assets/home/css/vendor.css')); ?>?v=<?php echo e(filemtime(public_path('assets/home/css/vendor.css'))); ?>">
    <link rel="stylesheet" type="text/css"
        href="<?php echo e(asset('/assets/home/css/style.css')); ?>?v=<?php echo e(filemtime(public_path('assets/home/css/style.css'))); ?>">
...
<body>
        ...
        <div class="offcanvas-body d-flex flex-column p-0">
            ...
            <div class="cart-items-wrapper flex-grow-1 overflow-auto p-3" id="offcanvas-cart-items">
                <?php if(isset($cartItems) && $cartItems->count() > 0): ?>
                    <?php $__currentLoopData = $cartItems; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $item): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                        <div class="cart-item d-flex align-items-center gap-3 border-bottom py-3"
                            id="offcanvas-item-<?php echo e($item->id); ?>">

                            
                            <img src="<?php echo e(asset('/' . $item->product->main_image)); ?>" width="60" height="60"
                                class="rounded object-fit-cover" alt="<?php echo e($item->product->product_name); ?>">
                            ...
                            <div class="flex-grow-1">
                                ...
                                <div class="d-flex align-items-center gap-2 mt-2">
                                    ...
                                    <span class="offcanvas-qty fw-semibold"
                                        data-cart-id="<?php echo e($item->id); ?>"><?php echo e($item->quantity); ?></span>
                ...
                <?php else: ?>
                    <div class="text-center py-5" id="empty-cart-msg">
                        <svg width="48" height="48" class="text-muted">
                            <use xlink:href="#cart"></use>
                        </svg>
                        <p class="mt-3 text-muted">Your cart is empty</p>
                        <a href="/" class="btn btn-primary btn-sm mt-2" data-bs-dismiss="offcanvas">Start
                            Shopping</a>
                    </div>
                <?php endif; ?>
            </div>
            ...
            <div class="cart-footer border-top p-3" id="offcanvas-cart-footer"
                ...
                <div class="d-flex justify-content-between mb-3">
                    ...
                    <strong class="text-primary offcanvas-total">&#8377;
    ...
    <script
        src="<?php echo e(asset('/assets/home/js/jquery-1.11.0.min.js')); ?>?v=<?php echo e(filemtime(public_path('assets/home/js/jquery-1.11.0.min.js'))); ?>">
    </script>
    <script defer
        src="<?php echo e(asset('/assets/home/js/plugins.js')); ?>?v=<?php echo e(filemtime(public_path('assets/home/js/plugins.js'))); ?>">
    </script>
    <script defer
        src="<?php echo e(asset('/assets/home/js/script.js')); ?>?v=<?php echo e(filemtime(public_path('assets/home/js/script.js'))); ?>">
    </script>
...
<?php /**PATH E:\xampp\htdocs\kalpakonline\resources\views/home/app.blade.php ENDPATH**/ ?>