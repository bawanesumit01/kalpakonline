...
<html lang="en">
  <head>
    ...
    <link rel="preload" href="<?php echo e(asset('/assets/home/css/vendor.css')); ?>" as="style">
    <link rel="preload" href="<?php echo e(asset('/assets/home/css/style.css')); ?>" as="style">
    <link rel="preload" href="<?php echo e(asset('/assets/home/js/jquery-1.11.0.min.js')); ?>" as="script">
  ...
  <body>
    ...
    <div class="offcanvas-header border-bottom">
        <h5 class="offcanvas-title">
            ...
            Your Cart
            <span class="badge bg-primary rounded-pill ms-2 cart-count"><?php echo e($cartCount ?? 0); ?></span>
        </h5>
    ...
    <div class="offcanvas-body d-flex flex-column p-0">
        ...
        <div class="cart-footer border-top p-3" id="offcanvas-cart-footer"
             style="<?php echo e(isset($cartItems) && $cartItems->count() > 0 ? '' : 'display:none'); ?>">
            <div class="d-flex justify-content-between mb-3">
                <span class="fw-semibold">Total</span>
                <strong class="text-primary offcanvas-total">&#8377; <?php echo e(number_format($cartTotal ?? 0, 2)); ?></strong>
            </div>
      ...
      <div class="offcanvas-body">
        ...
        <ul class="navbar-nav justify-content-end menu-list list-unstyled d-flex gap-md-3 mb-0">
          ...
          <li class="nav-item border-dashed active">
            <a href="<?php echo e(route('home.index')); ?>" class="nav-link d-flex align-items-center gap-3 text-dark p-2">
              ...
              <ul class="btn-toggle-nav list-unstyled fw-normal ps-5 pb-1">
                <?php $__currentLoopData = $categories; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $category): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                  <li class="border-bottom py-2">
                    <a href="#" class="dropdown-item"><?php echo e($category->category_name); ?></a>
                  </li>
                <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
              </ul>
            </div>
...
</html><?php /**PATH E:\xampp\htdocs\kalpakonline\resources\views/home/app.blade.php ENDPATH**/ ?>