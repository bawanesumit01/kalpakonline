...
<div class="shop-wrap">
  ...
  <aside class="shop-sidebar">
    ...
    <div class="s-section">
      ...
      <?php $__currentLoopData = $categories; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $category): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
        <label class="filter-label">
          <input type="radio" name="cat-filter" value="<?php echo e($category->id); ?>" onchange="applyFilters()">
          <?php echo e($category->category_name); ?>

          <span class="filter-count">(<?php echo e($category->products_count ?? ''); ?>)</span>
        </label>
  ...
  <div class="shop-main">
    ...
    <div class="shop-breadcrumb">
      <a href="<?php echo e(url('/')); ?>">Home</a> › <span>Shop</span>
    </div>
    ...
    <div class="cat-pills" id="cat-pills">
      ...
      <?php $__currentLoopData = $categories; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $category): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
        <div class="cat-pill" onclick="filterByPill('<?php echo e($category->id); ?>', this)"
...
const allCategories = <?php echo json_encode($categoriesJs); ?>;
  ...
  <div class="pcard${isList ? ' list-view' : ''}" id="pcard-${p.id}">
    <div class="pcard-img-wrap">
      <img src="${p.image}" alt="${p.name}" loading="lazy"
           onerror="this.src='<?php echo e(asset('/assets/images/default_product.png')); ?>'">
...
<?php echo $__env->make('home.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH /home/kalpakon/public_html/resources/views/home/shop.blade.php ENDPATH**/ ?>