            ...
            <div class="mdc-layout-grid">
                <div class="mdc-layout-grid__cell stretch-card mdc-layout-grid__cell--span-12">
                    <div class="mdc-card p-0">
                        ...
                        <!-- form -->
                        <form class="shadow pt-3" method="POST" action="<?php echo e(route('products.update', $product->id)); ?>"
                                ...
                                <div class="col-md-4 my-2">
                                    <div class="mdc-text-field mdc-text-field--outlined">
                                        <input class="mdc-text-field__input" id="product_name" type="text"
                                            name="product_name" value="<?php echo e(old('product_name', $product->product_name)); ?>"
                                ...
                                <div class="col-md-4 my-2">
                                    <div class="mdc-text-field mdc-text-field--outlined">
                                        <input class="mdc-text-field__input" id="product_sku" type="text"
                                            name="product_sku" value="<?php echo e(old('product_sku', $product->product_sku)); ?>"
                                            required autofocus autocomplete="product_sku">
                                        <div class="mdc-notched-outline">
                                            <div class="mdc-notched-outline__leading"></div>
                                            <div class="mdc-notched-outline__notch">
                                            ...
                                            <select class="mdc-text-field__input" id="vendor_id" name="vendor_id" required>
                                                ...
                                                <?php $__currentLoopData = $vendors; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $vendor): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                                    <option value="<?php echo e($vendor->vendor_id); ?>"
                                                        <?php echo e($vendor->vendor_id == $product->vendor_id ? 'selected' : ''); ?>>
                                ...
                                <div class="col-md-4 my-2">
                                    <div class="mdc-text-field mdc-text-field--outlined">
                                        <input class="mdc-text-field__input" id="cost_price" type="number"
                                            name="cost_price" value="<?php echo e(old('cost_price', $product->cost_price)); ?>"
                                            required autofocus autocomplete="cost_price">
                                        <div class="mdc-notched-outline">
                                            <div class="mdc-notched-outline__leading"></div>
                                            <div class="mdc-notched-outline__notch">
                                ...
                                <div class="col-md-4 my-2">
                                    <div class="mdc-text-field mdc-text-field--outlined">
                                        <input class="mdc-text-field__input" id="selling_price" type="number"
                                            name="selling_price"
                                            value="<?php echo e(old('selling_price', $product->selling_price)); ?>" required autofocus
                                ...
                                <div class="col-md-4 my-2">
                                    <div class="mdc-text-field mdc-text-field--outlined">
                                        <input class="mdc-text-field__input" id="min_stock_alert" type="number"
                                            step="0.01" name="min_stock_alert"
                                            value="<?php echo e(old('min_stock_alert', $product->min_stock_alert)); ?>"
                                    ...
                                    <div class="mdc-text-field mdc-text-field--outlined">
                                        <select class="mdc-text-field__input" id="stock_status" name="stock_status"
                                            ...
                                            <option value="in_stock"
                                                <?php echo e($product->stock_status == 'in_stock' ? 'selected' : ''); ?>>In Stock
                                            </option>
                                            <option value="out_of_stock"
                                                <?php echo e($product->stock_status == 'out_of_stock' ? 'selected' : ''); ?>>Out of
                                                Stock
                                            </option>
                                            <option value="pre_order"
                                                <?php echo e($product->stock_status == 'pre_order' ? 'selected' : ''); ?>>Preorder
                                            </option>
                                        </select>
                                        <div class="mdc-notched-outline">
                                            <div class="mdc-notched-outline__leading"></div>
                                ...
                                <div class="col-md-12 my-2">
                                    <div class="mdc-text-field mdc-text-field--outlined mdc-text-field--textarea">
                                        ...
                                        <textarea class="mdc-text-field__input" id="description" name="description" rows="4"
                                            autocomplete="description"><?php echo e(old('description', $product->description)); ?></textarea>
...
unset($__errorArgs, $__bag); ?>
                                    ...
                                    <!-- Image Preview -->
                                    <div class="mt-2">
                                        <img id="mainImagePreview" src="<?php echo e(asset('/' . $product->main_image)); ?>"
...
unset($__errorArgs, $__bag); ?>
                                    ...
                                    <div class="d-flex gap-2 mt-2 flex-wrap">
                                        <?php $__currentLoopData = $product->images; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $img): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                            <img src="<?php echo e(asset('/' . $img->image_path)); ?>" width="80"
                                    ...
                                    <div class="mdc-text-field mdc-text-field--outlined">
                                        <select class="mdc-text-field__input" id="status" name="status" required>
                                            ...
                                            <option value="inactive"
                                                <?php echo e($product->status == 'inactive' ? 'selected' : ''); ?>>
                                                Inactive</option>
...
<?php echo $__env->make('layouts.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH /home/kalpakon/public_html/resources/views/admin/products/edit.blade.php ENDPATH**/ ?>