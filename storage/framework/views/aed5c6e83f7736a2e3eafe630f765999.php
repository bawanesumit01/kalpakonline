            ...
            <div class="mdc-layout-grid">
                <div class="mdc-layout-grid__cell stretch-card mdc-layout-grid__cell--span-12">
                    <div class="mdc-card p-0">
                        ...
                        <!-- form -->
                        <form class="shadow pt-3" method="POST" action="<?php echo e(route('category.store')); ?>" enctype="multipart/form-data">
                            <?php echo csrf_field(); ?>
                            <div class="row m-2">
                                <!-- Category Name -->
                                <div class="col-md-6 my-2 ">
                                    <div class="mdc-text-field mdc-text-field--outlined">
                                        <input class="mdc-text-field__input" id="category_name" type="text"
                                            name="category_name" value="<?php echo e(old('category_name')); ?>" required autofocus
...
<?php echo $__env->make('layouts.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH /home/kalpakon/public_html/resources/views/admin/category/create.blade.php ENDPATH**/ ?>